    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Guest Analytics</h1>
            <p className="text-muted-foreground mt-1">Real-time DEI issue tracking from guest users</p>
          </div>
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Guest Analytics</h1>
            <p className="text-muted-foreground mt-1">Real-time DEI issue tracking from Supabase database</p>
          </div>
          <button
            onClick={() => refetch()}
            disabled={isFetching}
        ...
        {/* Top Performers Table - Guest user stats */}
