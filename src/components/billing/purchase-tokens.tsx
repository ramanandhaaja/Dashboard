...
import { CreditCard, Check, Zap, TrendingUp, Shield } from 'lucide-react';
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-gray-900">
                ${tokenPackages.find((p) => p.id === selectedPackage)?.price}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Tokens</span>
              <span className="text-sm font-medium text-gray-900">
                {tokenPackages.find((p) => p.id === selectedPackage)?.tokens.toLocaleString()}
              </span>
            </div>
